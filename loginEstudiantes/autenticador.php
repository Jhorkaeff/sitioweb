...
if(isset($_POST['iniciar'])){
    ...
    $result = "SELECT ID_E, Nombre, Contraseña FROM estudiante WHERE (LOWER(REPLACE(Nombre, ' ', '')) = '".strtolower(str_replace(' ', '',$username))."' OR LOWER(REPLACE(Correo, ' ', '')) = '".strtolower(str_replace(' ', '',$username))."') AND Contraseña = '$password'";
