...
if(isset($_POST['iniciar'])){
    ...
    $result = "SELECT ID_Pr, Nombre, Contraseña FROM profesor WHERE (LOWER(REPLACE(Nombre, ' ', '')) = '".strtolower(str_replace(' ', '',$username))."' OR LOWER(REPLACE(Correo, ' ', '')) = '".strtolower(str_replace(' ', '',$username))."') AND Contraseña = '$password'";
