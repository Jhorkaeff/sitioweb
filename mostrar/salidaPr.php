                    ...
                    <form>
                        <div class="picture">
                            ...
                            <?php                       
                                ...
                                $sql = "SELECT Imagen From profesor WHERE ID_Pr = '$I'";
                        ...
                        <div class="texto-todo">
                            <div class="matricula">
                                <?php
                                    ...
                                    $sql = "SELECT ID_Pr From profesor WHERE ID_Pr = '$I'";

                                    $result = $conn->query($sql);
                                    if ($result->num_rows > 0){
                                        while($row = $result->fetch_assoc()){
                                            echo "Matricula: " .$row['ID_Pr'];
                                        }
                                    }
                                    $conn->close();
                                ?>
                            ...
                            $sql = "SELECT Curso From profesor WHERE ID_Pr = '$I'";
                        ...
                        <div class="movil">
                            ...
                            $sql = "SELECT Telefono From profesor WHERE ID_Pr = '$I'";
