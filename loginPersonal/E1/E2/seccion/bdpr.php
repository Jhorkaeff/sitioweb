...
<?php
	...
	include("../../../../config/db.php");
		...
		switch($accion){
			...
			case "Modificar":
				$mysqli = new mysqli($servername, $username, $password, $db);
				$result = "UPDATE profesor SET Nombre = '$Nombre', Apellido = '$Apellido', Correo = '$Correo', Contraseña = '$Contra', Turno = '$Turno', Carrera = '$Carrera', Cuatrimestre = '$Cuatri', Modalidad = '$Mod', Telefono = '$Tel'  WHERE ID_E = '$ID'";
				$mysqli->query($result);
				...
				if(!empty($_FILES["Imagen"]["tmp_name"])) {
					...
					$mysqli = new mysqli($servername, $username, $password, $db);
					$result = "UPDATE profesor SET Imagen = '$Imagen' WHERE ID_E ='$ID'";
					$mysqli->query($result);
				}
			...
			case "Seleccionar":
				$mysqli = new mysqli($servername, $username, $password, $db);
				$result = "SELECT * FROM profesor WHERE ID_E = '$ID'";
			...
			case "Borrar":
				$mysqli = new mysqli($servername, $username, $password, $db);
				$result = "DELETE FROM profesor WHERE ID_E = '$ID'";
				$mysqli->query($result);
