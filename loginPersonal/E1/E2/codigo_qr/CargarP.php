...
<link rel="stylesheet" href="../../../../CSS/css/Cargar.css">
		...
		<div class="grid">
			<section class="main">
				<form action="CargarP.php" method="post" enctype="multipart/form-data">
			...
			if(isset($_POST['generar'])){
				...
				switch($_POST['qrd']){
					case "entrada":
						$urle = "../../mostrar/entradaP.php?ID=$ID";
						...
						$sql = "UPDATE qr SET NombreQR = '$imh', ImagenQRE = LOAD_FILE('C:/xampp/htdocs/sitioweb/loginPersonal/E1/E2/codigo_qr/temp/QRE.png') WHERE ID_Q = '$ID'";
						$mysqli->query($sql);
						$mysqli->close();
						break;

					case "salida":
						$urls = "../../mostrar/salidaP.php?ID=$ID";
						...
						$sql = "UPDATE qr SET NombreQR = '$imh', ImagenQRS = LOAD_FILE('C:/xampp/htdocs/sitioweb/loginPersonal/E1/E2/codigo_qr/temp/QRS.png') WHERE ID_Q = '$ID'";
						$mysqli->query($sql);
						$mysqli->close();
						break;
				}
